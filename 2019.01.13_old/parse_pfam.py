            ...
            for j, seq in enumerate(a):
                ...
                for ref in refs:
                    ...
                    if ref[0] == 'PDB':
                        ...
                        # 2019.01.09: Tai : just take into account the pdb_refs ....
                        if (int(uniprot_end)-int(uniprot_start)) == (int(pdb_end) - int(pdb_start)):  
                            pdb_refs.append([pfam[i, 0], j, uniprot_id, uniprot_start,
